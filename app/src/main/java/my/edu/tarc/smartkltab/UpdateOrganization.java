...
public class UpdateOrganization extends AppCompatActivity {
    ...
    String items[] = new String [] {"OrgName","OrgBranchLocation","OrgContactNum"};
    ...
    public void updateRecordOrg(View v) {
        ...
        if(editTextUpdateContent.getText().toString().matches("")){
            ...
            try {
                ...
                updateOrganization(this, "https://circumgyratory-gove.000webhostapp.com/update_organization.php", OrganizationID, updateItem, updateContent);
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void updateOrganization(Context context, String url, int id, String updateItem, String updateContent) {
        ...
        url = url + "?OrganizationID=" + id + "&UpdateItem=" + updateItem + "&UpdateContent=" + updateContent;
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success==0) {
                                    ...
                                    Toast.makeText(getApplicationContext(), message, Toast.LENGTH_LONG).show();
                                    Intent intent = new Intent(UpdateOrganization.this,OrganizationActivity.class);
